...
// app/share/[code]/error.jsx
// Error boundary for the Share page
...
export default function ShareError({ error, reset }) {
  useEffect(() => {
    console.error("[ShareError] Error caught:", error);
  }, [error]);
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 p-4">
      <div className="max-w-md w-full text-center">
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-2">
          We had trouble loading this shared list.
        </p>
        <p className="text-sm text-gray-500 dark:text-gray-500 mb-8">
          The link may be invalid or the list may no longer be available.
        </p>
