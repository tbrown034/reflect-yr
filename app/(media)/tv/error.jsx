...
// app/(media)/tv/error.jsx
// Error boundary for the TV shows listing page

import { useEffect } from "react";
import Link from "next/link";
import { ArrowPathIcon, HomeIcon, TvIcon } from "@heroicons/react/24/solid";

export default function TvError({ error, reset }) {
  useEffect(() => {
    console.error("[TvError] Error loading TV shows:", error);
  }, [error]);
      ...
      <div className="min-h-[50vh] flex items-center justify-center">
        <div className="max-w-md w-full text-center">
          <div className="bg-red-100 dark:bg-red-900/30 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-6">
            <TvIcon className="h-8 w-8 text-red-600 dark:text-red-400" />
          </div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            We couldn't fetch the TV show data. This might be a temporary issue with our data provider.
          </p>
