...
// app/(media)/movies/[id]/error.jsx
// Error boundary for individual movie detail pages

import { useEffect } from "react";
import Link from "next/link";
import { ExclamationTriangleIcon, ArrowPathIcon, ArrowLeftIcon, FilmIcon } from "@heroicons/react/24/solid";

export default function MovieDetailError({ error, reset }) {
  useEffect(() => {
    console.error("[MovieDetailError] Error loading movie details:", error);
  }, [error]);
      ...
      <div className="min-h-[50vh] flex items-center justify-center">
        <div className="max-w-md w-full text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            We couldn't load the details for this movie. It may have been removed or there's a temporary issue.
          </p>
