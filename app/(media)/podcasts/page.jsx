...
export const metadata = {
  title: "Podcasts | Sortid",
  description: "Discover and add popular podcasts to your lists",
};
...
export default async function PodcastsPage({ searchParams }) {
  ...
  // Fetch podcasts using the unified provider interface
  const podcasts = await discover("podcast", {
  ...
  return (
    <div className="container mx-auto px-3 sm:px-4 md:px-6 py-6 max-w-7xl">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 sm:mb-8 gap-4">
        <h1 className="text-2xl sm:text-3xl font-bold">Popular Podcasts of {displayYear}</h1>
        ...
        <div className="min-h-[40vh] flex items-center justify-center">
          <div className="text-center max-w-md">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              We couldn't find any podcasts for {displayYear}. Try a different year or search for specific shows.
            </p>
            <Link
              href={`/podcasts?year=${selectedYear}`}
